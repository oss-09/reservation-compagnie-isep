...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Passager passager1 = new Passager("PA001", "Osama Tim", "Paris", "0698765432", "TN123456");
        Reservation res1   = new Reservation("RES001", "2026-04-10", passager1, vol1);
        passager1.reserverVol(res1);

        vol1.listingPassagers();

        System.out.println("\n--- Lecture / Écriture de fichiers ---");
        GestionFichiers.initialiserFichierPassagers("passagers.csv");
        GestionFichiers.sauvegarderPassager("passagers.csv", passager1, res1);
        GestionFichiers.afficherPassagersDepuisFichier("passagers.csv");

        System.out.println("\n--- Recherche de vols via Amadeus API ---");
        System.out.println("API Amadeus désactivée - manque clés");
